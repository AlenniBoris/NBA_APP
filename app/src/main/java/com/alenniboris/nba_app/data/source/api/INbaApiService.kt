package com.alenniboris.nba_app.data.source.api

import android.app.Application
import com.alenniboris.nba_app.BuildConfig
import com.alenniboris.nba_app.data.source.api.model.CountriesResponseModel
import com.alenniboris.nba_app.data.source.api.model.GameResponseModel
import com.alenniboris.nba_app.data.source.api.model.LeaguesResponseModel
import com.alenniboris.nba_app.data.source.api.model.PlayerResponseModel
import com.alenniboris.nba_app.data.source.api.model.SeasonsResponseModel
...
interface INbaApiService {
    ...
    companion object {
        fun get(
            ...
            apl = apl,
            url = MyRetrofitValues.BASE_URL_NBA_API
        )
    }
