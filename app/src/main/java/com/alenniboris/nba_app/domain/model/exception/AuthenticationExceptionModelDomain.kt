...
sealed class AuthenticationExceptionModelDomain() : Throwable() {
    ...
    data object NotEmailTypeValueException : AuthenticationExceptionModelDomain()

    /* Thrown when password and password check are not equal */
    data object PasswordIsNotEqualWithItsCheckException : AuthenticationExceptionModelDomain()
    ...
    // and/or authenticate the user subject of that operationt
    */
    data object InvalidCredentialsException : AuthenticationExceptionModelDomain()
    ...
    */
    data object InvalidUserException : AuthenticationExceptionModelDomain()
    ...
    */
     ...
     */
    data object UserCollisionException : AuthenticationExceptionModelDomain()
