...
class NbaApiLeaguesNetworkRepositoryImplTest : KoinTest {
    ...
    private val testModule = module {
        single<INbaApiLeaguesService> {
            object : INbaApiLeaguesService {
                override suspend fun getLeaguesByCountry(countryId: Int): LeaguesResponseModel {
                    return mockedLeaguesResponse
                }
            }
        }
    }
    ...
    fun `function works and returns functions`() = runTest {
        ...
        assertEquals(res.result?.size, 2)
    }
